	  ...
	  <a class="activea" href="http://localhost:8080/coinweb/index.jsp"><span>Coinweb</span></a>
	    <div class="topnav-right">
	         <div class="cd-main-nav__list js-signin-modal-trigger">
	             <a class="cd" href="http://localhost:8080/coinweb/business/business.jsp">거래하기</a>
				 ...
				 <a href="http://localhost:8080/coinweb/Rangking/Rangk.jsp">랭킹</a>
      			 <a href="http://localhost:8080/coinweb/community/freeboard.jsp">자유게시판</a>
     <!--   <a href="#">코인소식</a>-->
    </div>
   </div>
 	<div class="dropdown">
		...
		<div class="cd-signin-modal__container"> <!-- this is the container wrapper -->
			...
			<div class="cd-signin-modal__block js-signin-modal-block" data-type="signup"> <!-- sign up form -->
				...
				<p class="cd-signin-modal__fieldset">
						...
						<input  class="cd-signin-modal__input cd-signin-modal__input--full-width cd-signin-modal__input--has-padding cd-signin-modal__input--has-border" id="signup-email"  name="email" type="email" placeholder="이메일 입력" >
						<span id="id_msg"></span>
					</p>
